...
const FEATURES = [
  {
    emoji: "\uD83E\uDDE0",
    title: "11 AI Personalities",
    desc: "Atlas, The Council, Dr. Flow, Insider, Max Payne, Satoshi, Quant King, Asia Tiger, Momentum, Sentinel, Vox Populi — each with distinct strategies.",
  },
  {
    emoji: "\uD83D\uDCE1",
    title: "Quant + LLM Hybrid",
    desc: "Quantitative signals (RSI, momentum, options flow) filtered by LLM conviction scoring. Backtested strategies only.",
  },
  {
    emoji: "\uD83D\uDCF1",
    title: "Social Tipping Points",
    desc: "Reddit, Google Trends, and news sentiment detect market-moving social signals before they become mainstream.",
  },
  {
    emoji: "\uD83D\uDEE1\uFE0F",
    title: "Risk Management",
    desc: "Sharpe ratio, Sortino ratio, max drawdown monitoring. Sentinel PM maintains constant hedge positions.",
  },
];
    ...
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <p className="text-xl text-gray-400 mb-10">
          11 AI Portfolio Managers. Quant + LLM Hybrid. One Mission.
        </p>
